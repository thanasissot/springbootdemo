...
public class StateEntryErrorA extends StateEntryActionBase {

    private final States state;

    public StateEntryErrorA(StatusEntityRepository statusEntityRepository, States state) {
    ...
    public void execute(StateContext<States, Events> context) {
        ...
        statusEntity.setLatestStateAErrorTs(now);
